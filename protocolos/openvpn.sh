...
if [[ ! -e /etc/openvpn/server/server.conf ]]; then  
	...
	clear
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${RESET}"
echo -e "${GREEN}      KevinTech OpenVPN${RESET}"
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${RESET}"
...
verb 3" > /etc/openvpn/server/client-common.txt  
	...
	echo  
	echo
echo -e "${GREEN}✔ OpenVPN instalado correctamente.${RESET}"
echo
echo -e "${YELLOW}Cliente:${RESET} $client"
echo -e "${YELLOW}Archivo:${RESET} ~/$client.ovpn"  
	echo  
