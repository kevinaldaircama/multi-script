...
def cb(c,m,u,i,x):
 ...
 if x in ('backup','backup_restore'):return edit(c,m,backup_text(d),[[{'text':'💾 Respaldar ahora','callback_data':'backup_now'},{'text':'♻️ Restaurar','callback_data':'restore'}]]+BACKUP_MENU)
